...
urlpatterns = [
    ...
    path('retorna_total_despesas', views.retorna_total_despesas, name="retorna_total_despesas"),
    path('retorna_total_saida', views.retorna_total_saida, name="retorna_total_saida")
]